return {
  ...
  dependencies = { "MunifTanjim/nui.nvim", "giusgad/hologram.nvim" },
    config = function()
        require("pets").setup({
            row = 9, -- the row (height) to display the pet at (higher row means the pet is lower on the screen), must be 1<=row<=10
            col = 5, -- the column to display the pet at (set to high number to have it stay still on the right side)
