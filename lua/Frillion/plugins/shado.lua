...
if (vim.fn.has("termguicolors") and vim.opt.termguicolors) or vim.fn.has("gui_running") then
    ...
    hl("StatusLine", { fg = colors.color_1, bg = nil, sp = colors.color_48, bold = true })
    hl("StatusLineNC", { fg = colors.color_1, bg = nil, sp = colors.color_48 })
    ...
    hl("Special", { fg = colors.color_23, bg = nil })
    ...
    -- DropBar Highlights --
    hl("DropBarKindFile", { link = "Directory", bold = true })
    hl("DropBarKindArray", { link = "Special" })
    hl("DropBarKindBoolean", { link = "Special" })
    hl("DropBarKindBreakStatement", { link = "Special" })
    hl("DropBarKindCall", { link = "Special" })
    hl("DropBarKindCaseStatement", { link = "Special" })
    hl("DropBarKindClass", { link = "Special" })
    hl("DropBarKindConstant", { link = "Special" })
    hl("DropBarKindConstructor", { link = "Special" })
    hl("DropBarKindContinueStatement", { link = "Special" })
    hl("DropBarKindDeclaration", { link = "Special" })
    hl("DropBarKindDelete", { link = "Special" })
    hl("DropBarKindDoStatement", { link = "Special" })
    hl("DropBarKindElseStatement", { link = "Special" })
    hl("DropBarKindElement", { link = "Special" })
    hl("DropBarKindEnum", { link = "Special" })
    hl("DropBarKindEnumMember", { link = "Special" })
    hl("DropBarKindEvent", { link = "Special" })
    hl("DropBarKindField", { link = "Special" })
    hl("DropBarKindFolder", { link = "Special" })
    hl("DropBarKindForStatement", { link = "Special" })
    hl("DropBarKindFunction", { link = "Special" })
    hl("DropBarKindH1Marker", { link = "Special" })
    hl("DropBarKindH2Marker", { link = "Special" })
    hl("DropBarKindH3Marker", { link = "Special" })
    hl("DropBarKindH4Marker", { link = "Special" })
    hl("DropBarKindH5Marker", { link = "Special" })
    hl("DropBarKindH6Marker", { link = "Special" })
    hl("DropBarKindIdentifier", { link = "Special" })
    hl("DropBarKindIfStatement", { link = "Special" })
    hl("DropBarKindInterface", { link = "Special" })
    hl("DropBarKindKeyword", { link = "Special" })
    hl("DropBarKindList", { link = "Special" })
    hl("DropBarKindMacro", { link = "Special" })
    hl("DropBarKindMarkdownH1", { link = "Special" })
    hl("DropBarKindMarkdownH2", { link = "Special" })
    hl("DropBarKindMarkdownH3", { link = "Special" })
    hl("DropBarKindMarkdownH4", { link = "Special" })
    hl("DropBarKindMarkdownH5", { link = "Special" })
    hl("DropBarKindMarkdownH6", { link = "Special" })
    hl("DropBarKindMethod", { link = "Special" })
    hl("DropBarKindModule", { link = "Special" })
    hl("DropBarKindNamespace", { link = "Special" })
    hl("DropBarKindNull", { link = "Special" })
    hl("DropBarKindNumber", { link = "Special" })
    hl("DropBarKindObject", { link = "Special" })
    hl("DropBarKindOperator", { link = "Special" })
    hl("DropBarKindPackage", { link = "Special" })
    hl("DropBarKindPair", { link = "Special" })
    hl("DropBarKindProperty", { link = "Special" })
    hl("DropBarKindReference", { link = "Special" })
    hl("DropBarKindRepeat", { link = "Special" })
    hl("DropBarKindRuleSet", { link = "Special" })
    hl("DropBarKindScope", { link = "Special" })
    hl("DropBarKindSpecifier", { link = "Special" })
    hl("DropBarKindStatement", { link = "Special" })
    hl("DropBarKindString", { link = "Special" })
    hl("DropBarKindStruct", { link = "Special" })
    hl("DropBarKindSwitchStatement", { link = "Special" })
    hl("DropBarKindTerminal", { link = "Special" })
    hl("DropBarKindType", { link = "Special" })
    hl("DropBarKindTypeParameter", { link = "Special" })
    hl("DropBarKindUnit", { link = "Special" })
    hl("DropBarKindValue", { link = "Special" })
    hl("DropBarKindVariable", { link = "Special" })
    hl("DropBarKindWhileStatement", { link = "Special" })
